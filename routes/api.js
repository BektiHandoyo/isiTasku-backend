...
const { getNewestLaporan, uploadLaporan, getAllCategories, deleteLaporanById, getLaporanDetail, getLaporanBySiswaId, getLaporanByCategories } = require('../controller/laporan.js');
...
router.get('/api/laporan/kategori/:kategori', getLaporanByCategories);
